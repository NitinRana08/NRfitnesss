...
function About({ closeAbout }) {
    return (
        <section
            id="about"
            className="bg-black text-white px-6 md:px-16 py-20 border-t border-zinc-900"
        >
            <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-14 items-center">
                ...
                <div className="overflow-hidden rounded-3xl">
                    <img
                        src="/aboutImg.jpg"
                        alt="NR Fitness"
                        className="w-full h-[300px] md:h-[500px] object-cover hover:scale-105 duration-500"
                    />
                </div>
                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
                        ...
                        <div className="bg-zinc-900 p-5 rounded-2xl border border-zinc-800 hover:border-red-500 hover:-translate-y-1 duration-300">
